Koobit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/koobit/files/Koobit/koobit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Koobit
...
New/changed settings (command-line or koobit.conf file)
--------------------------------------------------------
