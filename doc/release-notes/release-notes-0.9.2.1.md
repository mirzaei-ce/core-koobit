Koobit Core version 0.9.2.1 is now available from:

  https://koobit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KBT to 0.01 KBT
...
- Fix "Start koobit on system login"
