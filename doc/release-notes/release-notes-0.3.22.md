Download URL: https://sourceforge.net/projects/koobit/files/Koobit/koobit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 KBT fee schedule (users still pay 0.01 KBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #koobit00 - #koobit99
