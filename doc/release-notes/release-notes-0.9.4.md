Koobit Core version 0.9.4 is now available from:

  https://koobit.org/bin/0.9.4/
...
this update is incompatible with the Koobit system and could lead to consensus
forks.

Koobit Core released binaries from https://koobit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~koobit/+archive/ubuntu/koobit
- A third-party or self-compiled Koobit Core

upgrade to Koobit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
