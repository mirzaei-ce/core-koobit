Koobit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/koobit/files/Koobit/koobit-0.5.4/
...
http://gitorious.org/koobit/koobitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Koobit-Qt notifications under Growl 1.3.
Increase required age of Koobit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKoobit properly when installing Koobit-Qt over it. (Windows)
