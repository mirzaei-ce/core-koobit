...
unlocked to sign the Koobit-Qt.app bundle.
...
allowing somebody to distribute a Koobit-Qt.app or koobit-qt-setup.exe with a valid
...
that the koobit-qt.exe file inside the installer had not been tampered with.
