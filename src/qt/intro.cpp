...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/koobit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Koobit Core"),
     ...
     * override -datadir in the koobit.conf file in the default data directory
     * (to be consistent with koobitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
