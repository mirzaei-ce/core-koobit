...
#include "config/koobit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKoobitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KoobitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKoobitURI(info));
}
