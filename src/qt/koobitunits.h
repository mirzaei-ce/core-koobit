...
#ifndef KOOBIT_QT_KOOBITUNITS_H
#define KOOBIT_QT_KOOBITUNITS_H
...
/** Koobit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KoobitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KoobitUnits(QObject *parent);

    /** Koobit units.
      @note Source: https://en.koobit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KBT,
...
typedef KoobitUnits::Unit KoobitUnit;

#endif // KOOBIT_QT_KOOBITUNITS_H
