...
#if defined(NDEBUG)
# error "Koobit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Koobit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s KBT additional fees, %d delta bytes\n",
