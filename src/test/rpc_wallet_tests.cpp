...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CKoobitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CKoobitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CKoobitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CKoobitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CKoobitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKoobitAddress(arr[0].get_str()).Get() == demoAddress.Get());
