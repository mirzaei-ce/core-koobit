...
#ifndef KOOBIT_TEST_SCRIPTNUM10_H
#define KOOBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Koobit Core 0.10.0, for cross-comparison.
 */
public:
